...
const DoctorDashboard = () => {
          ...
          <div className="card" style={{ padding: '1.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                ...
                <p style={{ color: '#64748b', margin: 0, fontSize: '0.9rem' }}>Active Cases</p>
                <p style={{ color: '#9ca3af', margin: 0, fontSize: '0.8rem' }}>Under treatment</p>
              </div>
              <Activity size={24} style={{ color: '#64748b' }} />
            </div>
          </div>
        </div>
      </div>
  ...
  const renderPerformanceMetrics = () => (
    <div className="card" style={{ marginTop: '2rem', padding: '2rem' }}>
      <h4 style={{ color: '#1e293b', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        <TrendingUp size={20} />
        Performance Metrics
      </h4>
      ...
      <div className="grid grid-3" style={{ gap: '2rem' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <h5 style={{ color: '#1e293b', marginBottom: '0.5rem' }}>Patient Rating</h5>
          <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Based on 245 reviews</p>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <h5 style={{ color: '#1e293b', marginBottom: '0.5rem' }}>Success Rate</h5>
          <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Treatment outcomes</p>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <h5 style={{ color: '#1e293b', marginBottom: '0.5rem' }}>Avg Wait Time</h5>
          <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Patient satisfaction</p>
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div>
      ...
      <SuccessStories userRole="doctor" />
    </div>
  )
}
