...
const DoctorPatients = () => {
  ...
  const fetchPatientSummary = async (patientId) => {
    try {
      ...
      setPatientSummary('Unable to generate AI summary at this time.')
    }
  }
  ...
  const applyFilters = () => {
    ...
    if (filters.visitDate) {
      const filterDate = new Date(filters.visitDate).toDateString()
      filtered = filtered.filter(patient => 
        patient.last_visit_date && 
        new Date(patient.last_visit_date).toDateString() === filterDate
      )
    }
