...
import { Calendar, Users, Building2, Clock, Heart, Brain, Eye, Bone, Baby, Stethoscope, ChevronLeft, ChevronRight, Star, Phone, Mail, MapPin, Send, FileText, Activity, TrendingUp, MessageCircle } from 'lucide-react'
...
const Home = () => {
  ...
  const navigationSections = [
    ...
    { id: 'testimonials', label: 'Success Stories', icon: TrendingUp },
  ...
  return (
    <div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: activeSection === section.id ? '0 2px 8px rgba(59, 130, 246, 0.3)' : 'none'
                  }}
                  onMouseEnter={(e) => {
      ...
      <div id="specialties" style={{ padding: '4rem 0', backgroundColor: '#f8fafc' }}>
        <div className="container">
      ...
      <div id="services" style={{ padding: '4rem 0', backgroundColor: 'white' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#1e293b', marginBottom: '1rem' }}>
              Quick Access
            ...
            <p style={{ fontSize: '1.2rem', color: '#64748b', maxWidth: '600px', margin: '0 auto' }}>
              Access all platform features with one click
            </p>
          </div>
          ...
          <div className="grid grid-3" style={{ gap: '2rem' }}>
            ...
            onMouseLeave={(e) => {
              ...
              <Calendar size={60} style={{ color: '#3b82f6', margin: '0 auto 1rem' }} />
              <h3 style={{ marginBottom: '0.5rem', color: '#1e293b' }}>Book Appointment</h3>
              <p style={{ color: '#64748b', marginBottom: '1rem' }}>
                Schedule appointments with doctors across multiple hospitals
              </p>
            ...
            onMouseLeave={(e) => {
              ...
              <FileText size={60} style={{ color: '#10b981', margin: '0 auto 1rem' }} />
              <h3 style={{ marginBottom: '0.5rem', color: '#1e293b' }}>Health Records</h3>
              <p style={{ color: '#64748b', marginBottom: '1rem' }}>
                Upload and manage your medical reports and prescriptions
              </p>
            ...
            onMouseLeave={(e) => {
              ...
              <Activity size={60} style={{ color: '#f59e0b', margin: '0 auto 1rem' }} />
              <h3 style={{ marginBottom: '0.5rem', color: '#1e293b' }}>Health Analytics</h3>
              <p style={{ color: '#64748b', marginBottom: '1rem' }}>
                Track your health journey with detailed analytics and insights
              </p>
              <button className="btn" style={{ width: '100%', backgroundColor: '#f59e0b', color: 'white' }}>
                View Analytics
              </button>
            </div>
          </div>
      ...
      <div id="doctors" style={{ padding: '4rem 0', backgroundColor: '#f8fafc' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#1e293b', marginBottom: '1rem' }}>
      ...
      {/* Why Choose Us */}
      <div id="about" style={{ padding: '4rem 0', backgroundColor: '#f8fafc' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#1e293b', marginBottom: '1rem' }}>
      ...
      <div style={{ padding: '4rem 0', backgroundColor: '#f8fafc' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={{ fontSize: '1.2rem', color: '#64748b', maxWidth: '600px', margin: '0 auto' }}>
              Real results from real patients and doctors
            </p>
          </div>
          ...
          <div className="grid grid-3" style={{ gap: '2rem' }}>
            <div className="card" style={{ backgroundColor: 'white' }}>
              ...
              <div style={{ 
                ...
                <p style={{ margin: 0, fontWeight: '600' }}>40% better glucose control</p>
              </div>

              <p style={{ color: '#64748b', fontStyle: 'italic', lineHeight: '1.6' }}>
                "MedLinq helped me track my diabetes better than ever. The analytics showed patterns I never noticed!"
              </p>
            </div>
            ...
            <div className="card" style={{ backgroundColor: 'white' }}>
              ...
              <div style={{ 
                ...
                <TrendingUp size={20} style={{ marginBottom: '0.5rem' }} />
                <p style={{ margin: 0, fontWeight: '600' }}>300% more patients</p>
              </div>

              <p style={{ color: '#64748b', fontStyle: 'italic', lineHeight: '1.6' }}>
                "MedLinq transformed my practice. I now reach more patients and provide better care with data insights."
              </p>
            </div>
            ...
            <div className="card" style={{ backgroundColor: 'white' }}>
              ...
              <div style={{ 
                ...
                <Heart size={20} style={{ marginBottom: '0.5rem' }} />
                <p style={{ margin: 0, fontWeight: '600' }}>Prevented major cardiac event</p>
              </div>

              <p style={{ color: '#64748b', fontStyle: 'italic', lineHeight: '1.6' }}>
                "Early detection through MedLinq's health monitoring saved my life. Forever grateful!"
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Contact Information */}
      <div id="contact" style={{ padding: '3rem 0', backgroundColor: '#1e293b', color: 'white' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <p style={{ fontSize: '1.1rem', opacity: 0.9 }}>
              Get instant support through our chatbot or contact us directly
            </p>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '3rem', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                ...
                <p style={{ opacity: 0.9, margin: 0 }}>+91 1800-123-4567</p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                ...
                <p style={{ opacity: 0.9, margin: 0 }}>support@medlinq.com</p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                <p style={{ fontWeight: '600', marginBottom: '0.25rem' }}>Live Chat</p>
                <p style={{ opacity: 0.9, margin: 0 }}>Click the chat button</p>
              </div>
            </div>
          </div>
        </div>
