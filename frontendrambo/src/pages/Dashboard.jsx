...
import { Calendar, Users, Building2, Clock, User, Mail, Phone, Settings, Activity, Pill, FileText, Sun, Moon, Menu, X } from 'lucide-react'
        ...
        <div>
          <div className="grid grid-3 mb-6">
            <div className="card text-center">
              ...
              <h3 style={{ color: theme.text || '#1e293b', marginBottom: '0.5rem' }}>
                {stats.totalDoctors || 25}
              </h3>
              <p style={{ color: theme.textSecondary || '#64748b' }}>Total Doctors</p>
            </div>
            
            <div className="card text-center">
              <Calendar size={32} style={{ color: '#10b981', margin: '0 auto 0.5rem' }} />
              <h3 style={{ color: theme.text || '#1e293b', marginBottom: '0.5rem' }}>
                {stats.totalAppointments || 1250}
              </h3>
              <p style={{ color: theme.textSecondary || '#64748b' }}>Total Appointments</p>
            </div>
            
            <div className="card text-center">
              <Building2 size={32} style={{ color: '#f59e0b', margin: '0 auto 0.5rem' }} />
              <h3 style={{ color: theme.text || '#1e293b', marginBottom: '0.5rem' }}>
                {stats.totalPatients || 850}
              </h3>
              <p style={{ color: theme.textSecondary || '#64748b' }}>Registered Patients</p>
            </div>
          </div>

          <div className="card">
            <h3 style={{ marginBottom: '1.5rem', color: theme.text || '#1e293b' }}>Hospital Overview</h3>
            <div className="grid grid-2">
              <div>
                <h4 style={{ color: theme.text || '#1e293b', marginBottom: '1rem' }}>Recent Activity</h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                  <div style={{ 
                    ...
                    <p style={{ color: theme.text || '#1e293b', fontSize: '0.9rem' }}>
                      Emily Rodriguez → Dr. Sarah Johnson
                    </p>
                    <p style={{ color: theme.textSecondary || '#64748b', fontSize: '0.8rem' }}>
                      Today at 10:00 AM
                    </p>
                  </div>
                  <div style={{ 
              ...
              <div>
                <h4 style={{ color: theme.text || '#1e293b', marginBottom: '1rem' }}>Quick Actions</h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
